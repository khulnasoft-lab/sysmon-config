...
<Sysmon schemaversion="4.90">
	...
	<RuleGroup name="" groupRelation="or">
		<NetworkConnect onmatch="include">
			...
			<Image condition="image">cscript.exe</Image> <!--WindowsScriptingHost: | Credit @Cyb3rOps [ https://gist.github.com/khulnasoft-bot/00cded174a19f6268aa6cfa501310dfe ] -->
			...
			<Image condition="image">wmic.exe</Image> <!--WindowsManagementInstrumentation: Credit @Cyb3rOps [ https://gist.github.com/khulnasoft-bot/00cded174a19f6268aa6cfa501310dfe ] -->
	...
	<RuleGroup name="ImageBlock" groupRelation="or">
		<FileBlockExecutable onmatch="include">
			...
			<Image condition="image">RdrCEF.exe</Image> <!-- RdrCEF was seen dropping a DLL in temp (Example: \AppData\Local\Temp\acrocef_low\4616_1623006624_platform_specific\win_x86\widevinecdm.dll). Comment out this entry if you experience issues (https://github.com/khulnasoft-lab/sysmon-config/issues/43) -->
	...
	<!-- LOL DRIVER Sysmon Rules -->
		...
		<RuleGroup name="Malicious Driver Blocked" groupRelation="or">
			<FileBlockExecutable onmatch="include">
                <Hashes condition="contains">SHA256=56066ed07bad3b5c1474e8fae5ee2543d17d7977369b34450bd0775517e3b25c</Hashes>
                <Hashes condition="contains">SHA256=06a0ec9a316eb89cb041b1907918e3ad3b03842ec65f004f6fa74d57955573a4</Hashes>
                <Hashes condition="contains">SHA256=86047bb1969d1db455493955fd450d18c62a3f36294d0a6c3732c88dfbcc4f62</Hashes>
		...
		<RuleGroup name="Vulnerable Driver Drop Detected" groupRelation="or">
